...
CREATE TABLE accesorios (
    ...
    panel_control TEXT,
    resistencias_calefactoras VARCHAR(100),
    tension_resistencias INTEGER,
    potencia_resistencias VARCHAR(100),
    cables_incluidos VARCHAR(100),
...
-- COMMENT ON DATABASE catalogo_servelec IS 'Base de datos para gestión de productos SERVELEC';
