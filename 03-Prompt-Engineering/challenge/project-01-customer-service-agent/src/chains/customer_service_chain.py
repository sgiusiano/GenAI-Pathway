...
# Configure LangSmith project name
...
class CustomerServiceChain:
    ...
    def __init__(self):
        ...
        # Build the complete chain using LCEL with tracing
        self.complete_chain = (
    ...
    def process_query(self, query: str) -> dict[str, Any] | None:
        """
        ...
        try:
            ...
            # Process through the chain with tracing
            result = self.complete_chain.with_config(
                {"run_name": "customer_service_complete_chain"}
            ).invoke({"query": query})
